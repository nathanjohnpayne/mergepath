...
This repository follows the AI Agent Tooling Standard. See `BRAND.md` for this repository's relationship to the Standard (the reference implementation is mergepath; repositories bootstrapped from it are downstream consumers).
