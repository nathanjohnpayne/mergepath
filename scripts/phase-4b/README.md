...
| 7 | **feedback unaccounted** (#1000) — an earlier inline or top-level review-body finding lacks disposition evidence. No adapter ran and no handoff was rendered. Complete the named dispositions and re-run; do not route this status to manual fallback. |
