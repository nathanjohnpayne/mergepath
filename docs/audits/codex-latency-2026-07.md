...
Runbook/docs references to the folklore numbers ("15–40 min", "~4 min no-👀") should be replaced with the measured ones (verdict p50 3m37s / p90 7m6s / p99 10m30s; ack p99 13s) — that lands with the retune PRs.
