...
- [`rules.md`](rules.md) — every normative rule of Mergepath documented in English with a stable ID (R-1…R-203 for the review pipeline, G-1…G-292 for structure, governance, and deployment), each citing its canonical source. **●** marks configuration rules (machine-checkable arrangements of entities), **○** procedural ones.
