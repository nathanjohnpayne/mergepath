...
Two properties of that automation are load-bearing and are covered by `tests/test_audit_branch_protection.sh` and `tests/test_audit_branch_protection_workflow.sh`:
